...
import { AddDabbiColourForm } from './Form'
import { EditableTable } from '../EditableTable'
import { updateDabbiColour } from '../editActions'
import { PageHeader } from '@/components/ui/PageHeader'
import { SectionHeader } from '@/components/ui/SectionHeader'

export default async function DabbiColoursPage() {
  ...
  return (
    <div>
      <PageHeader title="Dabbi Colours" />
      ...
      {data && data.length > 0 && (
        <EditableTable
          ...
          action={updateDabbiColour}
        />
      )}
      <SectionHeader title="Add Dabbi Colour" />
      <AddDabbiColourForm />
    </div>
  )
}
